...
-- Script tự động khởi tạo dữ liệu chuyên khoa cho doctor_db với nội dung ĐẦY ĐỦ
...
VALUES 
-- 1. TIM MẠCH
('spec-001', 'Tim Mạch', 'Trung tâm can thiệp và điều trị bệnh lý tim mạch toàn diện.', 
...
-- 2. NHI KHOA
('spec-002', 'Nhi Khoa', 'Chăm sóc sức khỏe toàn diện cho trẻ em với môi trường thân thiện.', 
...
-- 3. THẦN KINH
('spec-003', 'Thần Kinh', 'Chuyên khoa sâu về não bộ, tủy sống và hệ thần kinh ngoại biên.', 
...
-- 4. CƠ XƯƠNG KHỚP
('spec-004', 'Cơ Xương Khớp', 'Điều trị các bệnh lý hệ vận động và chấn thương chỉnh hình.', 
...
-- 5. SẢN PHỤ KHOA
('spec-005', 'Sản Phụ Khoa', 'Đồng hành cùng phụ nữ trong hành trình làm mẹ và chăm sóc sức khỏe.', 
...
-- 6. UNG BƯỚU
('spec-006', 'Ung Bướu', 'Trung tâm điều trị ung thư theo tiêu chuẩn quốc tế.', 
...
-- 7. TIÊU HÓA
('spec-007', 'Tiêu Hóa', 'Chẩn đoán và điều trị bệnh lý dạ dày, đại tràng và gan mật.', 
...
-- 8. MẮT (NHÃN KHOA)
('spec-008', 'Mắt', 'Chăm sóc thị lực và phẫu thuật khúc xạ công nghệ cao.', 
...
-- 9. RĂNG HÀM MẶT
('spec-009', 'Răng Hàm Mặt', 'Nha khoa thẩm mỹ và phẫu thuật hàm mặt chuyên sâu.', 
...
-- 10. DA LIỄU
('spec-010', 'Da Liễu', 'Điều trị bệnh lý da liễu và thẩm mỹ da công nghệ cao.', 
...
-- 11. ĐA KHOA
('spec-011', 'Đa Khoa', 'Khám sức khỏe tổng quát và sàng lọc bệnh lý ban đầu.', 
'Khoa Đa khoa là nơi tiếp nhận và thăm khám ban đầu cho mọi đối tượng khách hàng. Chúng tôi cung cấp các dịch vụ kiểm tra sức khỏe định kỳ, tầm soát bệnh lý sớm và tư vấn chuyên sâu để định hướng điều trị đúng chuyên khoa.',
E'Khám sức khỏe tổng quát định kỳ\nTầm soát các bệnh lý mãn tính (tiểu đường, mỡ máu)\nKhám cấp giấy chứng nhận sức khỏe\nTư vấn và quản lý sức khỏe gia đình', 
E'Hệ thống xét nghiệm máu tự động hiện đại\nMáy siêu âm màu đa chiều\nCông nghệ chẩn đoán hình ảnh kỹ thuật số\nPhần mềm quản lý hồ sơ sức khỏe điện tử', 
'https://res.cloudinary.com/dpusohlya/image/upload/v1776872147/specialties/mhetrubsjvpplsst2dv4.jpg', NOW(), NOW()),

-- 12. NỘI TIẾT
('spec-012', 'Nội Tiết', 'Chuyên sâu điều trị tiểu đường và các rối loạn hormone.', 
'Khoa Nội tiết chuyên thăm khám và điều trị các bệnh lý liên quan đến rối loạn chức năng của hệ thống nội tiết và các hormone. Đặc biệt là quản lý và điều trị chuyên sâu bệnh tiểu đường, bệnh lý tuyến giáp và các rối loạn chuyển hóa.',
E'Điều trị tiểu đường tuýp 1 và tuýp 2\nĐiều trị các bệnh lý tuyến giáp (bướu cổ, suy giáp)\nQuản lý rối loạn mỡ máu và béo phì\nĐiều trị các rối loạn hormone sinh dục\nKiểm tra loãng xương do nội tiết', 
E'Máy đo đường huyết liên tục (CGM)\nXét nghiệm HbA1c tại chỗ nhanh chóng\nSiêu âm tuyến giáp độ phân giải cao\nCông nghệ xét nghiệm hormone định lượng chính xác', 
'https://res.cloudinary.com/dpusohlya/image/upload/v1776872682/specialties/mj6kxqdajbdzv3l50jsl.jpg', NOW(), NOW());
